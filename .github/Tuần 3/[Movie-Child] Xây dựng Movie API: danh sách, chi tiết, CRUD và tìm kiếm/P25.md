...
- Tổng hợp code Movie API cho NestJS.
- Khớp với SQL: `movies`, `genres`, `movie_genres`.
- Chức năng chính: xem danh sách phim, xem chi tiết phim, thêm phim, sửa phim, xóa mềm và tìm kiếm/lọc phim.

---

## 1. `src/movies/entities/genre.entity.ts`
...
## 2. `src/movies/entities/movie.entity.ts`
...
## 3. `src/movies/dto/create-movie.dto.ts`
...
## 4. `src/movies/dto/update-movie.dto.ts`
...
## 5. `src/movies/dto/movie-query.dto.ts`
...
## 6. `src/common/guards/admin.guard.ts`
...
## 7. `src/movies/movies.service.ts`
...
## 8. `src/movies/movies.controller.ts`
...
## 11. Test Postman - Admin thêm phim
...
## 12. Test Postman - Admin sửa phim
